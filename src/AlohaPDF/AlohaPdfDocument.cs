...
public class AlohaPdfDocument : IAlohaPdfDocument
{
        ...
        private void CalculateMargins()
    {
        ...
        float docInfoHeight = (_options.Info?.ShowInHeader == true && !string.IsNullOrWhiteSpace(_options.Info?.Author)) ? 32f : 0f;

        _firstPageTopMargin = PdfLayout.HeaderHeight + docInfoHeight;
        _repeatPageTopMargin = _options.RepeatHeader ? PdfLayout.HeaderHeight : PdfLayout.MarginDefault;
    }
    ...
    private void StartNewPage()
    {
        ...
        if (_currentPage == 1 && _options?.Info != null) DrawSimpleDocInfo();
    }
